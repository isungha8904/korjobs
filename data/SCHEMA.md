...
| `embed.title` | ≤ 256자 | 섹션별 기본 제목으로 **시작**(부제 덧붙이기 허용): 🔥 오늘의 핵심 3가지 / 📰 뉴스 더보기 / 🎥 볼 만한 영상 / 🧵 Threads 화제 / 💼 커리어·채용 시그널 / 📖 용어 한 스푼 |
...
| (임베드 합산) | ≤ 6,000자 | 디스코드는 임베드 하나의 제목+본문+footer **합산 6,000자**를 넘으면 발송을 거부함 — 봇이 사전 검증 |
